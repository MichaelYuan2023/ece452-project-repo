...
- [Aryan] developed a page feature which allows users to see their household details (e.g. roommates).
- [Kevin] developed a feature that allows chores to be marked as "completed". He also developed an edit chore functionality.
- [Shoheb] added more frequency options to the chore creation flow.
